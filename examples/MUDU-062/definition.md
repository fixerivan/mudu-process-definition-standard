...
| Otázka | Odpoveď |
| --- | --- |
| Kto proces spúšťa? | Vlastník alebo zástupca; záložný veriteľ iba pri zmene záložných údajov. |
| Čo úrad overuje? | Presnú pôvodnú a novú hodnotu, oprávnenie, doklady, poplatok a povinnú kontrolu lietadla aj všetkých motorov v SIS. |
| Aký je úspešný výsledok? | Zmenia sa iba schválené údaje a zachová sa história; nové osvedčenie vznikne len vtedy, ak sa mení údaj na osvedčení. |
| Čo sem nepatrí? | Prvý zápis je MUDU-061, výmaz MUDU-063 a oprava z vlastného podnetu zatiaľ nemá dohodnutú internú cestu. |
| Čo ešte treba rozhodnúť alebo opraviť? | Presný model zmeny, výpočet poplatku, reálne volanie SIS, okamih účinku a ochranu pred súbežnými zmenami. |
