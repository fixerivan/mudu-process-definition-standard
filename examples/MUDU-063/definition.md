...
| SRC-063-003 | LAW | Zákon č. 145/1995 Z. z., časová verzia | https://static.slov-lex.sk/static/SK/ZZ/1995/145/20260901.html | § 6 ods. 2; § 8-10; sadzobník položka92 písm. b) | účinné od 2026-09-01; raw HTML zachytené 2026-09-01 |
...
| SRC-063-006 | OFFICIAL_PROCEDURE | DÚ — Formuláre registra lietadiel | https://letectvo.nsat.sk/letova-sposobilost/register-lietadiel-slovenskej-republiky/formulare/ | žiadateľ, prílohové pravidlá a link F472 | pozorované 2026-09-01 |
...
| SRC-063-008 | CONFIGURATION | Katalóg služieb IS CRDÚ | not published in this repository | ID63 a susedné60/61/62/91 | zachytená lokálna revízia;private/project evidence reviewed internally;not redistributed |
| SRC-063-009 | CONFIGURATION | Aircraft registration EA/code context v2 | not published in this repository | ID60-63, EA14/108/13, CSV, XML, SharePoint, outputs a CLK | zachytené 2026-08-31;private/project evidence reviewed internally;not redistributed |
| SRC-063-010 | KNOWLEDGE_TRANSFER | MUDU knowledge transfer | not published in this repository | kanály podaní, strom entít, prílohy, Fabasoft, výstupy, správoplatnenie a CLK | lokálny zdroj prečítaný 2026-09-01;private/project evidence reviewed internally;not redistributed |
| SRC-063-011 | EA | EA objects, attributes and relations for MUDU-063 | not published in this repository | 14 objektov, 108 atribútov a 13 vzťahov | offline snapshot 2026-08-20; výber 2026-09-01;private/project evidence reviewed internally;not redistributed |
| SRC-063-012 | PETRIFLOW | vehicle.xml | not published in this repository | ID63 parent transition, candidate status and composition | zachytená lokálna revízia;private/project evidence reviewed internally;not redistributed |
| SRC-063-013 | PETRIFLOW | aircraft.xml | not published in this repository | ID63 part1/part2, reason_delete, component composition a confirm_validation | zachytená lokálna revízia;private/project evidence reviewed internally;not redistributed |
| SRC-063-014 | PETRIFLOW | ziadost_sluzby.xml | not published in this repository | ID63 portálová rekonštrukcia a existujúce komponenty | zachytená lokálna revízia;private/project evidence reviewed internally;not redistributed |
| SRC-063-015 | PETRIFLOW | backoffice_workflow_submission.xml | not published in this repository | vehicleDeleteDateSet a decision_valid register effect | zachytená lokálna revízia;private/project evidence reviewed internally;not redistributed |
| SRC-063-016 | CONFIGURATION | katalog_workflow.csv | not published in this repository | ID63 Iba poplatok | zachytená lokálna revízia;private/project evidence reviewed internally;not redistributed |
| SRC-063-017 | CONFIGURATION | lustracie_a_sluzby.csv | not published in this repository | ID63 NIE | zachytená lokálna revízia;private/project evidence reviewed internally;not redistributed |
| SRC-063-018 | CONFIGURATION | prilohy_formularov.csv | not published in this repository | štyri povinné riadky ID63 | zachytená lokálna revízia;private/project evidence reviewed internally;not redistributed |
| SRC-063-019 | CONFIGURATION | portal_spravne_poplatky.csv | not published in this repository | ID63 PEP kód3040 | zachytená lokálna revízia;private/project evidence reviewed internally;not redistributed |
| SRC-063-020 | CONFIGURATION | enum-definitions.json | not published in this repository | reason_delete: predaj, letecka-nehoda, ine | verzia konfigurácie prečítaná 2026-09-01;private/project evidence reviewed internally;not redistributed |
| SRC-063-021 | CONFIGURATION | word_templates.json | not published in this repository | štyri výstupy ID63 | zachytená lokálna revízia;private/project evidence reviewed internally;not redistributed |
| SRC-063-022 | OUTPUT_TEMPLATE | Osvedcenie_o_vymaze_z_RL.docx | not published in this repository | celý dokument | zachytená lokálna revízia;private/project evidence reviewed internally;not redistributed |
| SRC-063-023 | OUTPUT_TEMPLATE | Prerusenie_konania_DCL_vymaz_z_RL.docx | not published in this repository | celý dokument, header a footer | zachytená lokálna revízia;private/project evidence reviewed internally;not redistributed |
| SRC-063-024 | OUTPUT_TEMPLATE | Rozhodnutie_vymaz_lietadla.docx | not published in this repository | celý dokument, header a footer | zachytená lokálna revízia;private/project evidence reviewed internally;not redistributed |
| SRC-063-025 | OUTPUT_TEMPLATE | Zastavenie_konania_DCL_vymaz_z_RL.docx | not published in this repository | celý dokument, header a footer | zachytená lokálna revízia;private/project evidence reviewed internally;not redistributed |
| SRC-063-026 | SHAREPOINT | Historická žiadosť o výmaz lietadla | not published in this repository | celý historický input | zachytené 2026-08-31; historický input;private/project evidence reviewed internally;not redistributed |
| SRC-063-027 | SHAREPOINT | Vzor osvedčenia o výmaze | not published in this repository | presný source-set záznam | zachytené 2026-08-31; historický výstup;private/project evidence reviewed internally;not redistributed |
| SRC-063-028 | SOURCE_DRAFT | MUDU-063 graph-neighbourhood dossier | not published in this repository | 48 priamych vzťahov a reverzní konzumenti; navigácia, nie autorita | manuálne skontrolované 2026-09-01;private/project evidence reviewed internally;not redistributed |
| SRC-063-029 | SOURCE_DRAFT | MUDU-063 test/mock inventory | not published in this repository | task, reason_delete, kód3040 a integračné moduly | zapečatené zrkadlá; skontrolované 2026-09-01;private/project evidence reviewed internally;not redistributed |
