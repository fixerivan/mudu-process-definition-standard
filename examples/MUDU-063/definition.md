...
| Otázka | Odpoveď |
| --- | --- |
| Kto proces spúšťa? | Vlastník alebo zástupca; pri štyroch zákonných dôvodoch môže konanie začať aj Dopravný úrad. |
| Čo úrad overuje? | Aktuálny zápis, oprávnenie, dôvod a doklady; SIS sa pri výmaze podľa aktuálneho práva nekontroluje. |
| Aký je úspešný výsledok? | Aktuálny zápis a štátna príslušnosť sa ukončia, história zostane zachovaná a úrad vydá osvedčenie o výmaze. |
| Čo sem nepatrí? | Zmena údajov pred výmazom je MUDU-062; zmena Mode S alebo ELT je MUDU-091. |
| Čo ešte treba rozhodnúť alebo opraviť? | Presný okamih účinku, uzavretie všetkých aktívnych väzieb, internú cestu bez žiadosti a chybné šablóny. |
