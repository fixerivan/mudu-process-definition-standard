...
| FEE-060-003 | Aktuálny MUDU režim | Poplatok + lustrácia | Vytvorenie podania ID60 | CURRENT_IMPLEMENTATION | CONFIRMED | SRC-060-004 |
...
| STEP-060-007 | I1 | Podanie prijaté | MUDU aktivuje poplatkový a lustračný workflow. | Systém CRDÚ | Aktuálna konfigurácia ID60 | Technické podprocesy vytvorené | CURRENT_IMPLEMENTATION | CONFLICT | SRC-060-004 |
...
| INT-060-004 | INTEGRATION | CLK/SIS | Konfigurácia ID60 vyžaduje lustráciu,ale zákon SIS kontrolu viaže na MUDU-061/062 a zdrojový SIS branch nemá integračné volanie. | HIGH | CURRENT_IMPLEMENTATION | CONFLICT | SRC-060-001, SRC-060-004 |
...
| AC-060-005 | ID60 je nakonfigurované s CLK. | Spustí sa lustračná vetva. | Test nesmie považovať stav „odoslaná“ za dôkaz externého SIS volania a musí odhaliť chýbajúcu integráciu. | REQ-060-008,INT-060-004,MAP-060-008 | DRAFT |
...
| --- | --- | --- | --- | --- | --- |
| MAP-060-001 | Katalóg | katalog_sluzieb.csv | ID60,XML `vehicle`,Task `portal_aircraft_registration_mark_new_complete_form`;účel výslovne hovorí o predbežnom pridelení. | CONFIRMED | SRC-060-005 |
| MAP-060-002 | Petriflow | vehicle.xml | Transition `portal_aircraft_registration_mark_new_complete_form`. | CONFIRMED | SRC-060-004 |
...
| MAP-060-005 | Konfigurácia | katalog_workflow.csv | ID60 je `Poplatok + Lustrácie`. | CONFIRMED | SRC-060-004 |
...
| MAP-060-007 | Výstup | Rozhodnutie_o_prideleni_poznavacej_znacky.docx | Finishing output s režimom právoplatnosti 15 dní;šablóna opakuje jednoročné pravidlo. | CONFIRMED | SRC-060-006 |
...
| GAP-060-003 | EVIDENCE_GAP | Vyriešené vo verzii 0.1.1:aktuálna položka 92 písm. e) určuje 40 EUR za každú značku a § 6 ods. 2 určuje elektronické zníženie. | Bez ďalšieho rozhodnutia;pri novej časovej verzii predpisu obnoviť kontrolu. | Semantic author | CONFIRMED | SRC-060-008 |
| GAP-060-004 | IMPLEMENTATION_GAP | CLK je nakonfigurované pre ID60 bez zákonnej SIS väzby na predbežné pridelenie a integračná vetva nie je implementovaná. | Potvrdiť obchodný účel CLK;potom odstrániť alebo realizovať presne schválenú kontrolu. | Vecný gestor + Netgrif | CONFLICT | SRC-060-001, SRC-060-004 |
