...
| --- | --- | --- |
| REQ-060-001 | Žiadateľom je vlastník; konať môže aj riadne preukázaný zástupca. | Letecký zákon a formulár F469 |
| RULE-060-001, RULE-060-002, RULE-060-004 | Značka musí zodpovedať kategórii lietadla a nesmie byť súčasne pridelená inému lietadlu. | Vyhláška č. 274/2024 Z. z. |
| REQ-060-002 | Rozhodnutie platí jeden rok od právoplatnosti. | § 26 leteckého zákona |
| REQ-060-003 | Včasná žiadosť MUDU-061 zachová platnosť predbežného pridelenia. | § 26 leteckého zákona |
| REQ-060-006 | Predbežné pridelenie samo nevytvára zápis ani štátnu príslušnosť lietadla. | Hranica MUDU-060/061 |

## 5. Rozpory a otázky

| ID | Čo sme našli | Otázka pre gestora |
| --- | --- | --- |
| Q-060-001 | Zákon pozná aj špeciálnu značku na skúšobný let. | Patrí táto vetva do MUDU-060 alebo má byť samostatná? |
| GAP-060-002 | Formulár a dnešná konfigurácia požadujú viac príloh než aktuálna vyhláška výslovne uvádza. | Ktoré dodatočné prílohy majú zostať povinné a z akého dôvodu? |
| GAP-060-004 | Dnešná konfigurácia spúšťa lustráciu, ale zákon viaže kontrolu SIS na zápis a zmenu údajov. | Má sa pri MUDU-060 vykonávať nejaká lustrácia? |
| GAP-060-005 | Nie je preukázaná ochrana proti dvom súbežným žiadostiam o rovnakú značku. | V ktorom okamihu sa značka rezervuje a kedy sa uvoľní? |
