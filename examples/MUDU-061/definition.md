...
| --- | --- | --- |
| REQ-061-006 | Žiadosť podáva vlastník alebo jeho preukázaný zástupca. | Letecký zákon a postup DÚ |
| RULE-061-001, RULE-061-002 | Lietadlo musí spĺňať zákonné podmienky zápisu a nesmie zostať zapísané v cudzom registri. | § 25 a § 26 leteckého zákona |
| RULE-061-003 | Pred zápisom sa kontroluje lietadlo a každý motor v SIS. | § 26 leteckého zákona |
| RULE-061-010 | Jednoznačný nález v SIS blokuje zápis a oznamuje sa Policajnému zboru. | § 26 leteckého zákona |
| RULE-061-009 | Verejne sa zverejní iba zákonom povolený rozsah údajov. | § 26 leteckého zákona |

## 5. Rozpory a otázky

| ID | Čo sme našli | Otázka pre gestora |
| --- | --- | --- |
| GAP-061-001 | Verejný formulár a konfigurácia príloh nezodpovedajú presne aktuálnej vyhláške. | Ktorá matica údajov a príloh je záväzná? |
| GAP-061-005 | Dnešná vetva CLK/SIS nepreukazuje skutočné odoslanie a odpoveď. | Aký výsledok SIS musí systém uložiť, aby mohol zápis pokračovať? |
| GAP-061-004 | Právny text poplatku nepokrýva jednoznačne MTOW presne 5 701 kg. | Aká sadzba sa má použiť pre 5 701 kg? |
| GAP-061-006 | Šablóny prerušenia a zastavenia opisujú iný proces. | Ktoré procesovo správne výstupy má MUDU-061 používať? |
| GAP-061-008 | Nie je presne zviazané doručenie, rozklad, právoplatnosť, zápis a vydanie osvedčenia. | V akom poradí nastávajú právne a registerové účinky? |
| GAP-061-011 | Nie je preukázaná ochrana pred dvom zápismi rovnakého lietadla alebo značky. | Kedy vzniká rezervácia a ako sa rieši súbeh? |
